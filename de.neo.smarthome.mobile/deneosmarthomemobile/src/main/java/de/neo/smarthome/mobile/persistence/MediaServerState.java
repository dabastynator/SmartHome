...
public class MediaServerState extends DomainBase {
	...
	public PlayingBean volUp() throws RemoteException, PlayerException {
		ArrayList<IWebMediaServer.BeanMediaServer> list = mWebMediaServer.getMediaServer(mMediaServerID);
	...
	public ArrayList<IWebMediaServer.BeanPlaylistItem> getPlayListContent(String playlist) throws RemoteException, PlayerException {
	...
	public IWebMediaServer.BeanDownload publishForDownload(String file) throws RemoteException, IOException {
