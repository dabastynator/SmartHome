...
public class SerialReader extends Thread {
	...
	private void informListener(String familyCode, int switchNumber, de.neo.smarthome.api.IWebSwitch.State state) {
			...
			try {
				...
				while ((line = mInput.readLine()) != null) {
					...
					if (!matcher.matches()) {
						...
						de.neo.smarthome.api.IWebSwitch.State switchState = (matcher.group(3).equals("1")
								|| matcher.group(3).equals("ON")) ? de.neo.smarthome.api.IWebSwitch.State.ON
										: de.neo.smarthome.api.IWebSwitch.State.OFF;
	...
	public interface ISerialListener {
		...
		public void OnSwitchEvent(String family, int switchNumber, de.neo.smarthome.api.IWebSwitch.State state);
