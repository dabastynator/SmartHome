      ...
      public void actionPerformed(ActionEvent e) {
        try {
          ...
          for (String d : BrowserPanel.this.directories)
            if (d.equals(BrowserPanel.this.fileList.getSelectedItem())) {
              BrowserPanel.this.browser.goTo(BrowserPanel.this.fileList.getSelectedItem());
              BrowserPanel.this.updateContent();
              return;
            }
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        try
        {
          ...
          Object response = JOptionPane.showInputDialog(source, 
            "Select Playlist", 
            "Select the Playlist that will be extended", 
            3, null, plsList, 
            plsList[0]);
          if (response != null)
